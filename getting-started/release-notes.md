...
* DL4J now supports NWC (channels last - [minibatch, sequence_length, size]) for all RNN and CNN 1D layers, in addition to NCW [Link](https://github.com/KonduitAI/deeplearning4j/pull/379)
...
* WordVectorSerializer now has methods for reading from InputStreams, not just files [Link](https://github.com/eclipse/deeplearning4j/pull/8908)
* Added support for registering custom loss functions for Keras import [Link](https://github.com/KonduitAI/deeplearning4j/pull/427)
* Added MultiLayerNetwork.close() and ComputationGraph.close() methods to immediately deallocate all network memory (parameters, gradients, updater state, workspace memory) [Link](https://github.com/KonduitAI/deeplearning4j/pull/460)



#### Bug Fixes and Optimizations

* Removed GloVe implementation due to being not properly maintained and not widely used due to N*N memory requirements [Link](https://github.com/KonduitAI/deeplearning4j/pull/437)
...
* Added MKLDNN (DNNL/OneDNN) support for depthwise_conv2d operation for DL4J and SameDiff [Link](https://github.com/KonduitAI/deeplearning4j/pull/156)
...
* Updated documentation links (in javadoc, exceptions etc) for new website URLs [link](https://github.com/KonduitAI/deeplearning4j/pull/452), [Link](https://github.com/KonduitAI/deeplearning4j/pull/453)
* ParallelWrapper now closes worker models using MultiLayerNetwork/ComputationGraph.close() at the end of each iteration [Link](https://github.com/KonduitAI/deeplearning4j/pull/461)
...
* Added new linalg operations namespace
    * triangular_solve [Link](https://github.com/KonduitAI/deeplearning4j/pull/173)
...
* Added tensormmul_bp op [Link](https://github.com/KonduitAI/deeplearning4j/pull/231)
...
* Added lstmLayer_bp operation [Link](https://github.com/KonduitAI/deeplearning4j/pull/370)
* Added gru_bp operation [Link](https://github.com/KonduitAI/deeplearning4j/pull/377)
...
* Added ResourceUtils.listClassPathfiles method for nd4j-common-tests module [Link](https://github.com/KonduitAI/deeplearning4j/pull/416)
* Added gradient sharing operations [Link](https://github.com/KonduitAI/deeplearning4j/pull/436)
...
* Some packages relocated to avoid split packages (that can be a problem for OSGi and Java 9 modules) [Link](https://github.com/KonduitAI/deeplearning4j/pull/411)
    * Note: this is a breaking change for some class packages/imports. See [this link](https://github.com/KonduitAI/deeplearning4j/pull/411) for details on exact package changes
* Dropped support for iOS binaries for now; iOS support will be re-added in a future release [Link](https://github.com/KonduitAI/deeplearning4j/pull/451)
...
* Fixed an issue where resize_bicubic operation did not match Tensorflow for some configuration values [Link](https://github.com/eclipse/deeplearning4j/issues/8539) [Link](https://github.com/KonduitAI/deeplearning4j/pull/130)
...
* Performance optimization for multiple operations: softmax, squeeze, expand_dims, tanh [Link](https://github.com/KonduitAI/deeplearning4j/pull/242)
...
* Fixed some operation implementations when operating on views (Batch/Space to Space/Batch/Depth; batchnorm_bp) [Link](https://github.com/KonduitAI/deeplearning4j/pull/402)
...
* Optimized workspace allocations to reduce number of native function calls [Link](https://github.com/KonduitAI/deeplearning4j/pull/420)
* Fixed an issue where SameDiff listeners would not get all requested variables if variable execution is not required for training [Link](https://github.com/KonduitAI/deeplearning4j/pull/423)
* Fixed an issue where Nd4j.getMemoryManager().memcpy did not check buffer type [Link](https://github.com/KonduitAI/deeplearning4j/pull/430), [Link](https://github.com/eclipse/deeplearning4j/issues/8909)
* Optimization: MKLDNN (OneDNN) concatenation operation added [Link](https://github.com/KonduitAI/deeplearning4j/pull/443)
* Fixed an issue when creating DataBuffer/INDArray from ByteBuffer instances for some datatypes [Link](https://github.com/KonduitAI/deeplearning4j/pull/446)
* Fixes and improvements for threshold encoding [Link](https://github.com/KonduitAI/deeplearning4j/pull/447), [Link](https://github.com/KonduitAI/deeplearning4j/pull/449), [Link](https://github.com/KonduitAI/deeplearning4j/pull/456)
* Fixed an issue where casting of empry arrays would sometimes  not have the same shape as the input array [Link](https://github.com/KonduitAI/deeplearning4j/pull/457)
...
* ImageRecordReader: added NHWC layout support [Link](https://github.com/KonduitAI/deeplearning4j/pull/431)
* NativeImageLoader: added NHWC support [Link](https://github.com/KonduitAI/deeplearning4j/pull/432)
...
* Deleted not properly maintained modules: datavec-cammel, datavec-perf [Link](https://github.com/KonduitAI/deeplearning4j/pull/175)
...
* Arbiter UI now has multi-session support [Link](https://github.com/eclipse/deeplearning4j/pull/8872)

#### Bug Fixes and Optimizations

* Fixes an issue with GridSearchCandidateGenerator not worknig correctly for some cases [Link](https://github.com/eclipse/deeplearning4j/issues/8751), [Link](https://github.com/KonduitAI/deeplearning4j/pull/292)
