...
* [Apache Maven](./#apache-maven) \(automated build and dependency manager\)
* [IntelliJ IDEA](./#intellij-idea) or Eclipse
* [Git](./#git)
...
If you are new to Java or unfamiliar with these tools, read the details below for help with installation and setup. Otherwise, **skip to** [**DL4J Examples**](./#examples).
